...
impl FaviconHandler {
    ...
    #[inline]
    pub fn is_favicon_request<D>(req: &Request<'_, '_, D>) -> bool {
    ...
    pub fn handle_request<'a, D>(&self, req: &Request<'_, '_, D>, mut res: Response<'a, D>) -> MiddlewareResult<'a, D> {
    ...
    pub fn send_favicon<'a, D>(&self, req: &Request<'_, '_, D>, mut res: Response<'a, D>) -> MiddlewareResult<'a, D> {
