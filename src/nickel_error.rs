...
pub struct NickelError<D = ()> {
    pub stream: Option<Response<D>>,
    pub message: Cow<'static, str>
}

impl<D> NickelError<D> {
...
impl<T, D> From<(Response<D>, (StatusCode, T))> for NickelError<D>
